class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>, നിങ്ങളുടെ ഗ്രൂപ്പിൽ സിനിമ ആവശ്യമാണ് എന്ന് എനിക്കറിയാം
എന്നാൽ എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ ചേർക്കുക എന്നിട്ട് അഡ്മിൻ ആക്കുക.
പിന്നെ ഒന്നും നോക്കണ്ട എല്ലാ സിനിമയും ഞാൻ തരാം♥️♥️🔥"""
    HELP_TXT = """𝙷𝙴𝚈 {}
