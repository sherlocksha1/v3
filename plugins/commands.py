...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/new_movies_group_2021')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/new_movies_group_2021'),
            InlineKeyboardButton('💠 CHAИИΞL 💠', url='https://t.me/new_all_movies_club')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**നിങ്ങൾക്ക് സിനിമ കിട്ടണമെങ്കിൽ താഴെക്കാണുന്ന JOIИ CHAИИΞL എന്നത് ക്ലിക്ക് ചെയ്ത് Join ചെയ്ത് തിരികെ വന്ന് movie യുടെ name ഇട്ടാല്‍ സിനിമ കിട്ടുന്നതാണ്💯**",
